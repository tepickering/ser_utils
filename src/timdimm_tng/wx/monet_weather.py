...
def parse_monet():
    ...
    try:
        ...
        page = urlopen('https://weather.monet.suth.saao.ac.za/api/sensors/', context=ctx)
    ...
    monet_wx['TimeStamp_SAST'] = datetime.datetime.utcnow() + datetime.timedelta(hours=2)
...
def main():
    ...
    if monet['Valid']:
        ...
        print(f'Connection is down or information from MONET is invalid: {monet["Error"]}')
