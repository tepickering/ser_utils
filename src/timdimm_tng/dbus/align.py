...
class Align(
    ...
    @dbus_method(
        result_signature='i',
        method_name='getLoadAndSlewStatus'
    )
    ...
    @dbus_method(
        input_signature='d',
        method_name='setTargetPositionAngle'
    )
