...
class Ekos(
    ...
    @dbus_method(
        input_signature='b',
        method_name='setEkosLiveConnected'
    )
    ...
    @dbus_method(
        input_signature='sb',
        method_name='setEkosLoggingEnabled'
    )
