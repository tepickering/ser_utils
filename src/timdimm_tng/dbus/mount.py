...
class EkosMountInterface(
    ...
    @dbus_method(
        input_signature='bd',
        method_name='setMeridianFlipValues'
    )
    ...
    @dbus_property(
        property_signature='b',
        property_name='altitudeLimitsEnabled'
    )
    ...
    @dbus_property(
        property_signature='b',
        property_name='hourAngleLimitEnabled'
    )
    ...
    @dbus_property(
        property_signature='ad',
        property_name='equatorialCoords'
    )
    ...
    @dbus_property(
        property_signature='ad',
        property_name='horizontalCoords'
    )
